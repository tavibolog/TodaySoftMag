...
public class BookService {
    ...
    @POST
    @Path("/reset")
    public Response reset(@HeaderParam("clearOnly") boolean clearOnly, @CookieParam("credentials") String credentials) {
        books.clear();
        if (!clearOnly) {
        ...
        return Response.ok(credentials != null ? credentials : "reset").build();
    }
